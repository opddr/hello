...
static int hello_init(void)
{
	...
	printk("module start\n");
	thread = kthread_create(donkiEntry,NULL,"thread");
	if(thread)
	{	
		printk("thread created success : %x\n",thread);
